...
public final class NodeListNodeSymbol extends AstNode {

    private final List<NodeSymbol> value;
    private final java_cup.runtime.symbol.complex.ComplexLocation location;

    public NodeListNodeSymbol(List<NodeSymbol> value, java_cup.runtime.symbol.complex.ComplexLocation location) {
        this.value = value;
        this.location = location;
    }

    public List<NodeSymbol> getValue() {
        return value;
    }
    ...
    public String toString() {
        return "List<symbol>" + '{' + value.size() + '}' + location;
    }
