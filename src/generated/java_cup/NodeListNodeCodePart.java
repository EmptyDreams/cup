...
public final class NodeListNodeCodePart extends AstNode {

    private final List<NodeCodePart> value;
    private final java_cup.runtime.symbol.complex.ComplexLocation location;

    public NodeListNodeCodePart(List<NodeCodePart> value, java_cup.runtime.symbol.complex.ComplexLocation location) {
        this.value = value;
        this.location = location;
    }

    public List<NodeCodePart> getValue() {
        return value;
    }
    ...
    public String toString() {
        return "List<code_part>" + '{' + value.size() + '}' + location;
    }
