...
public final class NodeListNodeSymbolId extends AstNode {

    private final List<NodeSymbolId> value;
    private final java_cup.runtime.symbol.complex.ComplexLocation location;

    public NodeListNodeSymbolId(List<NodeSymbolId> value, java_cup.runtime.symbol.complex.ComplexLocation location) {
        this.value = value;
        this.location = location;
    }

    public List<NodeSymbolId> getValue() {
        return value;
    }
    ...
    public String toString() {
        return "List<symbol_id>" + '{' + value.size() + '}' + location;
    }
