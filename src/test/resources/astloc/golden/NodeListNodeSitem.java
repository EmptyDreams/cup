...
public final class NodeListNodeSitem extends AstNode {

    private final List<NodeSitem> value;
    private final java_cup.runtime.symbol.complex.ComplexLocation location;

    public NodeListNodeSitem(List<NodeSitem> value, java_cup.runtime.symbol.complex.ComplexLocation location) {
        this.value = value;
        this.location = location;
    }

    public List<NodeSitem> getValue() {
        return value;
    }
    ...
    public String toString() {
        return "List<sitem>" + '{' + value.size() + '}' + location;
    }
