...
public final class NodeListNodeItem extends AstNode {

    private final List<NodeItem> value;
    private final java_cup.runtime.symbol.complex.ComplexLocation location;

    public NodeListNodeItem(List<NodeItem> value, java_cup.runtime.symbol.complex.ComplexLocation location) {
        this.value = value;
        this.location = location;
    }

    public List<NodeItem> getValue() {
        return value;
    }
    ...
    public String toString() {
        return "List<item>" + '{' + value.size() + '}' + location;
    }
