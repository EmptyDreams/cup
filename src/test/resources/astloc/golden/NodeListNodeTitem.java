...
public final class NodeListNodeTitem extends AstNode {

    private final List<NodeTitem> value;
    private final java_cup.runtime.symbol.complex.ComplexLocation location;

    public NodeListNodeTitem(List<NodeTitem> value, java_cup.runtime.symbol.complex.ComplexLocation location) {
        this.value = value;
        this.location = location;
    }

    public List<NodeTitem> getValue() {
        return value;
    }
    ...
    public String toString() {
        return "List<titem>" + '{' + value.size() + '}' + location;
    }
