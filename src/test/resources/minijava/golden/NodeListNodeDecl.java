...
public final class NodeListNodeDecl extends AstNode {

    private final List<NodeDecl> value;
    private final java_cup.runtime.symbol.complex.ComplexLocation location;

    public NodeListNodeDecl(List<NodeDecl> value, java_cup.runtime.symbol.complex.ComplexLocation location) {
        this.value = value;
        this.location = location;
    }

    public List<NodeDecl> getValue() {
        return value;
    }
    ...
    public String toString() {
        return "List<decl>" + '{' + value.size() + '}' + location;
    }
