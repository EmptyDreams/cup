...
public final class NodeListNodeStmt extends AstNode {

    private final List<NodeStmt> value;
    private final java_cup.runtime.symbol.complex.ComplexLocation location;

    public NodeListNodeStmt(List<NodeStmt> value, java_cup.runtime.symbol.complex.ComplexLocation location) {
        this.value = value;
        this.location = location;
    }

    public List<NodeStmt> getValue() {
        return value;
    }
    ...
    public String toString() {
        return "List<stmt>" + '{' + value.size() + '}' + location;
    }
